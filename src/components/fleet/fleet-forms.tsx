...
export function CreateVehicleForm({ departments }: { departments: { id: string; name: string }[] }) {
  ...
  return (
    <form action={formAction} style={{ display: 'flex', gap: 8, alignItems: 'flex-end', flexWrap: 'wrap', border: '1px solid var(--dim-border-soft)', padding: 12, borderRadius: 6 }}>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Plaka</label><input name="plateNo" required style={{ padding: 6, width: 100 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Marka</label><input name="brand" style={{ padding: 6, width: 100 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Model</label><input name="model" style={{ padding: 6, width: 100 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Yıl</label><input name="year" type="number" style={{ padding: 6, width: 70 }} /></div>
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Yakıt Tipi</label>
      ...
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Ruhsat Bitiş (ops.)</label><input name="registrationExpiryDate" type="date" style={{ padding: 6 }} /></div>
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Sorumlu Departman (ops.)</label>
...
export function CreateVehicleInsuranceForm({ vehicles }: { vehicles: { id: string; plateNo: string }[] }) {
  ...
  return (
    <form action={formAction} style={{ display: 'flex', gap: 8, alignItems: 'flex-end', flexWrap: 'wrap', border: '1px solid var(--dim-border-soft)', padding: 12, borderRadius: 6 }}>
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Araç</label>
        <select name="vehicleId" required style={{ padding: 6, minWidth: 100 }}>
          <option value="">Seçin</option>
          {vehicles.map((v) => <option key={v.id} value={v.id}>{v.plateNo}</option>)}
        </select>
      </div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Poliçe No</label><input name="policyNo" required style={{ padding: 6, width: 120 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Şirket</label><input name="provider" style={{ padding: 6, width: 140 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Kapsam (Trafik/Kasko)</label><input name="coverageType" style={{ padding: 6, width: 100 }} /></div>
      ...
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Prim (ops.)</label><input name="premium" type="number" step="0.01" style={{ padding: 6, width: 90 }} /></div>
...
export function CreateFleetMaintenancePlanForm({ vehicles, departments }: { vehicles: { id: string; plateNo: string }[]; departments: { id: string; name: string }[] }) {
  ...
  return (
    <form action={formAction} style={{ display: 'flex', gap: 8, alignItems: 'flex-end', flexWrap: 'wrap', border: '1px solid var(--dim-border-soft)', padding: 12, borderRadius: 6 }}>
      ...
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Sorumlu Departman</label>
      ...
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Bakım Tipi</label>
      ...
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Sıklık</label>
      ...
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Aralık</label><input name="intervalValue" type="number" min="1" defaultValue="1" style={{ padding: 6, width: 60 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Başlangıç</label><input name="startDate" type="date" required style={{ padding: 6 }} /></div>
...
export function RunFleetMaintenanceGenerationButton() {
  ...
  return (
    <form action={formAction} style={{ display: 'inline-block' }}>
      ...
      {state?.error ? <span style={{ color: 'var(--dim-danger)', fontSize: 12, marginLeft: 6 }}>{state.error}</span> : null}
      {state?.success ? <span style={{ color: 'var(--dim-success)', fontSize: 12, marginLeft: 6 }}>{state.success}</span> : null}
    </form>
  );
}
...
export function RecordVehicleExpenseForm({ vehicles }: { vehicles: { id: string; plateNo: string }[] }) {
  ...
  return (
    <form action={formAction} style={{ display: 'flex', gap: 8, alignItems: 'flex-end', flexWrap: 'wrap', border: '1px solid var(--dim-border-soft)', padding: 12, borderRadius: 6 }}>
      ...
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Gider Tipi</label>
      ...
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Tarih</label><input name="expenseDate" type="date" required style={{ padding: 6 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Tutar</label><input name="amount" type="number" step="0.01" required style={{ padding: 6, width: 90 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Litre (yakıt, ops.)</label><input name="quantity" type="number" step="0.01" style={{ padding: 6, width: 80 }} /></div>
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Kilometre (ops.)</label><input name="odometerKm" type="number" step="0.1" style={{ padding: 6, width: 90 }} /></div>
