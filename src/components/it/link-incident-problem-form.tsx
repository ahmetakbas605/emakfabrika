...
import { linkIncidentToProblemAction, type FormState } from '@/actions/it/problems';

export function LinkIncidentProblemForm({ departmentId, problems, incidents }: { departmentId: string; problems: { id: string; title: string }[]; incidents: { id: string; title: string }[] }) {
  const action = linkIncidentToProblemAction.bind(null, departmentId);
