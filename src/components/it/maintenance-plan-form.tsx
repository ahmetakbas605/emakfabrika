  ...
  return (
    <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: 8, border: '1px solid var(--dim-border-soft)', padding: 12, borderRadius: 6, maxWidth: 520 }}>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        <div style={{ flex: 1 }}>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Varlık (opsiyonel — boşsa genel/lokasyon bazlı)</label>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        ...
        <div>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Aralık</label>
          <input name="intervalValue" type="number" min={1} defaultValue={1} style={{ padding: 6, width: 70 }} />
        </div>
      </div>
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Başlangıç Tarihi</label>
        <input name="startDate" type="date" required style={{ padding: 6 }} />
      </div>
      <div style={{ display: 'flex', gap: 8 }}>
        <div style={{ flex: 1 }}>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Teknisyen (opsiyonel)</label>
        ...
        <div style={{ flex: 1 }}>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Checklist Şablonu (opsiyonel)</label>
