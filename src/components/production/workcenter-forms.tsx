...
export function CreateWorkCenterForm() {
  ...
  return (
    <form action={formAction} style={{ display: 'flex', gap: 8, alignItems: 'flex-end', flexWrap: 'wrap', border: '1px solid var(--dim-border-soft)', padding: 12, borderRadius: 6 }}>
      ...
      <div><label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Kapasite/Saat (ops.)</label><input name="capacityPerHour" type="number" step="0.01" style={{ padding: 6, width: 100 }} /></div>
