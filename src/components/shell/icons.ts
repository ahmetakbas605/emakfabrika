import {
  ...
  Palmtree,
  // Görsel Yenileme Faz 2 — tüm modül menüsü için (bkz. app/dashboard/layout.tsx)
  Factory, Wrench, Truck, Leaf, Scale, Briefcase, Wallet, Plug, Workflow,
  ShoppingCart, ClipboardCheck, HardHat, FlaskConical, BarChart3, Gauge, CalendarClock
} from 'lucide-react';
...
export const ICONS = {
  ...
  factory: Factory, wrench: Wrench, truck: Truck, leaf: Leaf, scale: Scale,
  briefcase: Briefcase, wallet: Wallet, plug: Plug, workflow: Workflow,
  cart: ShoppingCart, clipboardCheck: ClipboardCheck, hardHat: HardHat,
  flask: FlaskConical, chart: BarChart3, gauge: Gauge, calendarClock: CalendarClock
} as const;
