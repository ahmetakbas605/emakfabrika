  ...
  return (
    <form action={formAction} style={{ border: '1px solid var(--dim-border-soft)', padding: 16, borderRadius: 6, display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        <div>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Talep Türü</label>
        ...
        <div>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>CAPEX/OPEX</label>
        ...
        <div>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Maliyet Merkezi</label>
        ...
        <div>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Bütçe Kalemi</label>
        ...
        <div>
          <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>İstenen Teslim Tarihi</label>
      ...
      <div>
        <label style={{ display: 'block', fontSize: 12, color: 'var(--dim-on-surface-variant)' }}>Gerekçe</label>
      ...
      <div>
        ...
        {lines.map((line, i) => (
          <div key={i} style={{ border: '1px solid var(--dim-border-soft)', borderRadius: 4, padding: 10, marginBottom: 8, display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'flex-end' }}>
              <div style={{ flex: 1, minWidth: 180 }}>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Açıklama</label>
                <input value={line.description} onChange={(e) => updateLine(i, { description: e.target.value })} style={{ padding: 5, width: '100%' }} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Miktar</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Tahmini Birim Fiyat</label>
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              <div>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Master Ürün (opsiyonel)</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Stok Kartı (stok kontrolü için)</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Depo (stok kartı seçiliyse zorunlu)</label>
              ...
              <div>
                <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Tercih Edilen Marka</label>
                <input value={line.preferredBrand} onChange={(e) => updateLine(i, { preferredBrand: e.target.value })} style={{ padding: 5, width: 140 }} />
              </div>
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 11, color: 'var(--dim-on-surface-variant)' }}>Teknik Şartname</label>
