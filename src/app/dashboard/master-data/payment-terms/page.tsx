...
export default async function PaymentTermsPage() {
  ...
  return (
    <div>
      ...
      <p style={{ color: 'var(--dim-on-surface-variant)', marginBottom: 20, fontSize: 13 }}>Peşin, NET_7, NET_30 gibi parametrik vade tanımları (madde 38).</p>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, marginBottom: 20 }}>
        ...
        <tbody>
          ...
          {terms.length === 0 ? <tr><td colSpan={3} style={{ padding: '8px', color: 'var(--dim-slate)' }}>Henüz ödeme vadesi yok.</td></tr> : null}
        </tbody>
      </table>
