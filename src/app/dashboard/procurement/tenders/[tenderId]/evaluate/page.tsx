    ...
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 24 }}>
        {[...commercialTargets.values()].map((t) => (
          <div key={t.tenderBidId} style={{ border: '1px solid #ddd', borderRadius: 6, padding: 10, minWidth: 200 }}>
        ...
        {commercialTargets.size === 0 ? <p style={{ color: '#999', fontSize: 13 }}>Henüz teklif yok.</p> : null}
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              {row.cells.map((cell, i) => (
                <tr key={cell.supplierPartyId} style={{ borderBottom: '1px solid #f0f0f0', background: i === 0 && cell.weightedTotal !== null ? '#f4fbf4' : undefined }}>
                  ...
                  <td style={{ padding: '4px 8px' }}>
                    ...
                    ) : <span style={{ color: '#999' }}>Teklif yok</span>}
                  </td>
