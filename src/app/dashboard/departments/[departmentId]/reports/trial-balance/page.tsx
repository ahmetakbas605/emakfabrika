...
export default async function TrialBalancePage({ params }: { params: Promise<{ departmentId: string }> }) {
  ...
  return (
    <div>
      ...
      <p style={{ color: '#666', marginBottom: 20, fontSize: 13 }}>Yalnızca muhasebeleşmiş (POSTED) fişler dahildir — ters kaydı alınmış fişler hariç.</p>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
        ...
        <tfoot>
          <tr style={{ borderTop: '2px solid #333', fontWeight: 700 }}>
            ...
            <td style={{ padding: '6px 8px', textAlign: 'right', color: Math.abs(totalDebit - totalCredit) < 0.005 ? '#080' : '#b00' }}>
