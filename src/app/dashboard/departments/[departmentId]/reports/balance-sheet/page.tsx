...
export default async function BalanceSheetPage({ params }: { params: Promise<{ departmentId: string }> }) {
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      <p style={{ color: '#666', marginBottom: 20, fontSize: 13 }}>Mizandan türetilir — sıfır bakiyeli hesaplar gösterilmez.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 14, fontWeight: 700, borderTop: '2px solid #333', paddingTop: 10 }}>
      ...
      <p style={{ marginTop: 8, fontSize: 13, color: balanced ? '#080' : '#b00', fontWeight: 600 }}>{balanced ? 'Bilanço denk.' : 'BİLANÇO DENGESİZ — bir hata var.'}</p>
    </div>
  );
}
