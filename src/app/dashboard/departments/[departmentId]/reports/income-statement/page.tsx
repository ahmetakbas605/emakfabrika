...
export default async function IncomeStatementPage({ params }: { params: Promise<{ departmentId: string }> }) {
  ...
  return (
    <div style={{ maxWidth: 560 }}>
      ...
      <p style={{ color: 'var(--dim-on-surface-variant)', marginBottom: 20, fontSize: 13 }}>Vergi karşılığı hesaplanmamıştır — dönem net kârı/zararı vergi öncesidir (bkz. MEVZUAT-MAP.md).</p>
      ...
      <div style={{ borderTop: '1px solid var(--dim-border)', paddingTop: 10, fontSize: 16, fontWeight: 700, color: positive ? '#080' : 'var(--dim-danger)' }}>
