...
export default async function SupplierQualityPage({ params, searchParams }: { params: Promise<{ partyId: string }>; searchParams: Promise<{ from?: string; to?: string }> }) {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p style={{ color: 'var(--dim-on-surface-variant)', marginBottom: 20, fontSize: 13 }}>Giriş muayenesi kabul oranı ve NCR geçmişi, talep üzerine hesaplanır — saklanan bir skor DEĞİL.</p>
